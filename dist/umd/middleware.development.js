    ...
    var persistStorage = {
      getItem: function getItem(name) {
        ...
        if (str instanceof Promise) {
          return str.then(function (res) {
            return options.deserialize == null ? void 0 : options.deserialize(res);
          });
        }
        return (options.deserialize == null ? void 0 : options.deserialize(str)) || JSON.parse(str);
      },
      setItem: function setItem(name, newValue) {
        var _options;
        return storage.setItem(name, ((_options = options) == null ? void 0 : _options.serialize == null ? void 0 : _options.serialize(newValue)) || JSON.stringify(newValue));
      },

  ...
  const persistStorage = {
    getItem: (name) => {
      ...
      if (str instanceof Promise) {
        return str.then((res) => {
          var _a2;
          return (_a2 = options.deserialize) == null ? void 0 : _a2.call(options, res);
        });
      }
      return ((_b = options.deserialize) == null ? void 0 : _b.call(options, str)) || JSON.parse(str);
    },
    setItem: (name, newValue) => {
      var _a;
      return storage.setItem(name, ((_a = options == null ? void 0 : options.serialize) == null ? void 0 : _a.call(options, newValue)) || JSON.stringify(newValue));
    },
